                            ...
                            <Card id="" className="">
                                ...
                                <Card.Body >
                                    <div className="d-flex align-items-center">
                                        ...
                                        <form className="post-text"   onClick={handleShow}>
                                    ...
                                    <div className="user-post-data">
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div className="">
                                                <div className="d-flex justify-content-between">
                                                    <div>
                                                        <h5 className=" d-inline-block">Paige Turner</h5>
                                                        <p className=" ps-1 d-inline-block">Added New Video in his Timeline</p>
                                                        <p className="text-primary">1 day ago</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
